...
(function ()
{
    ...
    /* The chip grid that used to sit under the case files is gone,
       and the handler that gave its presses somewhere to land went
       with it. Every matter is now reachable by opening one of
       three tabs, which the CSS does on its own. Nothing here
       needs to run for the practice areas to work. */
